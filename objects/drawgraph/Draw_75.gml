...
draw_text_colour(700,874,string(global.coinCount), #f6c9ad,#f6c9ad,c_white,c_white,1)
draw_sprite(coinicon,0,600,866)
...
draw_text_transformed_colour(83,720,text,0.7,0.9,0,#5B2418,#5B2418,#5B2418,#5B2418,1)
